...
import { FiPackage, FiUsers, FiBarChart } from 'react-icons/fi';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400 mt-2">
          Welcome back, {adminUser?.full_name || adminUser?.email || 'Admin'} 
          {isSuperAdmin && <span className="ml-2 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800 dark:bg-yellow-800 dark:text-yellow-100">Super Admin</span>}
        </p>
      </div>
          ...
          return (
            <div key={card.title} className="relative group">
              <Link
                ...
                className={`block p-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow duration-200 h-full ${
                  canAccess 
